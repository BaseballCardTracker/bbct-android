...
public abstract class BaseballCardProviderTest<T extends BaseballCardProvider> extends ProviderTestCase2<T> {
    ...
    public void setUp() throws Exception {
        ...
        DatabaseUtils.createDbFromSqlStatements(
            ...
            BaseballCardSQLHelper.SCHEMA_VERSION,
    ...
    public void testPreConditions() {
        ...
        Assert.assertTrue(
            dbUtil.containsAllBaseballCards(BaseballCardProviderTest.CARDS)
        );
    }
        ...
        if (cursor != null) {
            while (!cursor.moveToNext()) {
                int value = cursor.getInt(
                    cursor.getColumnIndex(BaseballCardContract.VALUE_COL_NAME)
                );
